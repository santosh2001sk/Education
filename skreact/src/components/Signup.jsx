          ...
          >
            <body>
              ...
              <tr>
                <td>UserName :</td>
                <td>
                  <input className="border m-1" type="text" name="username" placeholder="Username"/>
                </td>
              </tr>
              <tr>
                <td>Name :</td>
              ...
              <tr>
                <td>Password :</td>
                <td>
                  <input className="border m-1" placeholder="Password" type="password" name="password1" />
                </td>
              </tr>
              <tr>
                <td>Re-Type Password :</td>
                <td>
                  <input className="border m-1" placeholder="Re-type" type="password" name="password2" />
                </td>
              </tr>
              <tr>
                <td>
